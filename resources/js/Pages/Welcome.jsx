...
export default function Welcome() {
	...
	const steps = [
		{ title: t('steps.siapkan_data'), desc: t('steps.siapkan_data_desc'), img: "/assets/img/ilustrasi/ilustrasi-meteran-listrik@2x.png" },
		{ title: t('steps.input_id'), desc: t('steps.input_id_desc'), img: "/assets/img/ilustrasi/ilustrasi-input-id-pelanggan@2x.png" },
		{ title: t('steps.cek_tagihan'), desc: t('steps.cek_tagihan_desc'), img: "/assets/img/ilustrasi/payment-bill-time-illustration@2x.png" },
		{ title: t('steps.klik_bayar'), desc: t('steps.klik_bayar_desc'), img: "/assets/img/ilustrasi/ilustrasi-klik-tombol-cek-tagihan@2x.png" },
		{ title: t('steps.metode_bayar'), desc: t('steps.metode_bayar_desc'), img: "/assets/img/ilustrasi/mobile-payment-illustration@2x.png" },
		{ title: t('steps.instruksi'), desc: t('steps.instruksi_desc'), img: "/assets/img/ilustrasi/search-illustration@2x.png" },
		{ title: t('steps.konfirmasi'), desc: t('steps.konfirmasi_desc'), img: "/assets/img/ilustrasi/user-profile-illustration@2x.png" },
		{ title: t('steps.selesai'), desc: t('steps.selesai_desc'), icon: CheckCircle2 }
	];
					...
					<div className="flex flex-wrap items-center -mx-4">
						...
						>
                            <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm rounded-full border border-slate-200 dark:border-slate-700">
                                ...
                                <span className="text-sm font-semibold dark:text-slate-300 tracking-wide uppercase">{t('hero.badge')}</span>
                            </div>
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                <Button size="lg" variant="outline" className="h-16 px-10 rounded-2xl text-lg font-bold border-slate-200 dark:border-slate-800 dark:text-white hover:bg-slate-50 dark:hover:bg-slate-900 hover:scale-105 active:scale-95 transition-all shadow-sm" asChild>
                                    <Link href="/how-to-pay">{t('hero.cta_guide')}</Link>
                                </Button>
                            </div>
						</motion.div>
						<motion.div 
			...
			<section className="py-24 bg-slate-50 dark:bg-slate-950 transition-colors">
				<div className="container px-4 mx-auto">
					<div className="text-center mb-20">
						<h2 className="text-3xl lg:text-4xl font-bold mb-4 dark:text-white">{t('steps.cara_bayar_title')}</h2>
						<p className="text-slate-500 dark:text-slate-400">{t('steps.cara_bayar_subtitle')}</p>
					</div>
			...
			<section className="py-24 bg-slate-50 dark:bg-slate-900 transition-colors">
				<div className="container px-4 mx-auto">
					<div className="flex flex-wrap -mx-4 items-center">
						...
						>
							<h2 className="text-4xl font-bold mb-8 dark:text-white max-w-md">{t('benefits.title')}</h2>
							<div className="space-y-6">
								{[
									{ icon: CreditCard, title: t('benefits.auto_payment'), desc: t('benefits.auto_payment_desc') },
									{ icon: Wallet, title: t('benefits.cashback'), desc: t('benefits.cashback_desc') },
									{ icon: ShieldCheck, title: t('benefits.security'), desc: t('benefits.security_desc') }
								].map((benefit, i) => (
						...
						>
							<div className="bg-primary/10 p-12 rounded-[3rem] relative border border-primary/20">
								...
								<h3 className="text-2xl font-bold mb-6 dark:text-white">{t('benefits.about')}</h3>
								<p className="text-slate-600 dark:text-slate-400 mb-8 leading-loose text-sm">
									{t('benefits.about_desc')}
								</p>
								<div className="flex items-center gap-4">
									...
									<div>
										...
										<p className="text-sm text-slate-500 dark:text-slate-400">{t('benefits.lead_admin')}</p>
									</div>
								</div>
							</div>
						</motion.div>
			...
			<section className="py-24 bg-white dark:bg-slate-950 transition-colors overflow-hidden relative">
				<div className="container px-4 mx-auto relative z-10">
					...
					>
						...
						<h2 className="text-4xl lg:text-5xl font-black mb-8">{t('cta.title')}</h2>
