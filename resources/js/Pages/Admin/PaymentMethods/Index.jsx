      ...
      <div className="flex-1 flex flex-col gap-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 shrink-0">
          <div>
            <h2 className="text-xl md:text-2xl font-black tracking-tight">
              Metode <span className="text-primary italic">Pembayaran</span>
            </h2>
        ...
        <Card className="bg-white dark:bg-slate-900 border-none shadow-sm rounded-xl">
          <CardHeader className="flex flex-row items-center justify-between">
            <CardTitle className="text-sm font-bold">Daftar Metode Pembayaran</CardTitle>
          </CardHeader>
          <CardContent>
            {!paymentMethods || (paymentMethods.data || []).length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-[11px] text-slate-500 dark:text-slate-400">Tidak ada data metode pembayaran</p>
              </div>
            ) : (
              <>
