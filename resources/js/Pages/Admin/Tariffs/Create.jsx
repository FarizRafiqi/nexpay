        ...
        <AuthenticatedLayout auth={auth}>
            ...
            <div className="flex-1 flex flex-col gap-4">
                <div className="flex items-center justify-between">
                    <div>
                        <h2 className="text-xl md:text-2xl font-black tracking-tight">Tambah Tarif</h2>
                        <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">Buat tarif listrik baru</p>
                    </div>
