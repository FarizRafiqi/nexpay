      ...
      <div className="flex-1 flex flex-col gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-black tracking-tight">
                Tambah <span className="text-primary italic">Penggunaan</span>
              </h2>
              <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-1">
                Catat pemakaian listrik pelanggan
              </p>
            </div>
          </div>
        </div>
        ...
        >
          <Card className="bg-white dark:bg-slate-900 border-none shadow-sm rounded-xl">
            <CardHeader>
              <CardTitle className="text-sm font-bold">Informasi Penggunaan</CardTitle>
            </CardHeader>
            <CardContent>
